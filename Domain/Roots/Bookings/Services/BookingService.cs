...
public class BookingService : IBookingService
{
    ...
    public async Task UpdateBooking(int id, DateTime startDate, DateTime endDate, Guest guest, int partySize, string note)
    {
        ...
        booking.Update(startDate, endDate, guest, partySize, note);
